...
uses
  ...
  MCPConnect.MCP.Middleware.Headers in '..\..\Source\MCPConnect.MCP.Middleware.Headers.pas',
  MCPConnect.MCP.Middleware.RequestMeta in '..\..\Source\MCPConnect.MCP.Middleware.RequestMeta.pas',
  ...
  MCPConnect.MCP.Response in '..\..\Source\MCPConnect.MCP.Response.pas',
  ...
  MCPConnect.Tests.Transport.RequestHeaders in 'MCPConnect.Tests.Transport.RequestHeaders.pas',
  MCPConnect.Tests.Transport.RequestMeta in 'MCPConnect.Tests.Transport.RequestMeta.pas',
  ...
  MCPConnect.Tests.MCP.Response in 'MCPConnect.Tests.MCP.Response.pas',
