program MCPAuthServerWebBroker;
{$APPTYPE GUI}
...
uses
  ...
  MCPAuthServerWebBroker.Form.Main in 'MCPAuthServerWebBroker.Form.Main.pas' {frmMain},
  MCPAuthServerWebBroker.WebModule in 'MCPAuthServerWebBroker.WebModule.pas' {WebModule1: TWebModule},
